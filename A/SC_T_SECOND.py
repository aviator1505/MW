...
mon = monitors.Monitor('myMonitor', width=42.0, distance=70.0)
...
sc_img = visual.ImageStim(win, image='SC_v2.jpg')
...
#            intervals = [3, 6, 9, 12] # Intervals at which drift correct should occur.
#            # Skip drift-check if running the script in Dummy Mode
#            while not dummy_mode and current_index in intervals:
...
########################################################################################################################
        ...
        page = visual.ImageStim(win, image=stimFile.iloc[current_index], size = (1600, 1200))
        page.draw()
        win.flip()
